...
public class Student {
	...
	public Student(int grade, int ban, int num, String name, int korean, 
		...
		//여기서 토탈을 계산하는데 밑의 국수영 set메서드에서 왜 또 계산하는가? ->
	...
	public void setKorean(int korean) {
		...
		//여기서 this.english 이렇게 안해도 인스턴스 변수 없어서 가능
